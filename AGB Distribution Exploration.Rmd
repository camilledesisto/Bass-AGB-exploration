...
tdat_fam <- with(AGBdat , aggregate(AGBtree, list(Famille=Famille), sum))
...
top_abund <-  
  species_count_2 %>%
    top_frac(n = 0.1, wt = x)
for (i in 1:NROW(species_count_2)) {
  print(species_count_2$genus_spp[i])
  print(species_count_2$perc[i])
}


View(species_count_2)
